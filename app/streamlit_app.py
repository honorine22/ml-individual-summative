...
def render_insights_tab():
    ...
    if curated_manifest.exists():
        ...
        with col1:
            ...
            # Interpretation
            st.info("""
            **Insight**: The dataset shows relatively balanced distribution across fault types. 
            This helps prevent class imbalance issues during training.
            """)
        ...
        with col2:
            ...
            # Interpretation
            st.info("""
            **Insight**: 80/20 split ensures sufficient training data while maintaining 
